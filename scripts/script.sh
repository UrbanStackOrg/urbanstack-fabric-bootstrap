...
echo "Updating anchor peers for aphp..."
updateAnchorPeers 0 1
echo "Updating anchor peers for org2..."
updateAnchorPeers 0 2

## Install chaincode on peer0.aphp and peer0.org2
echo "Installing chaincode on peer0.aphp..."
...
# Query chaincode on peer0.aphp
echo "Querying chaincode on peer0.aphp..."
chaincodeQuery 0 1 100

# Invoke chaincode on peer0.aphp
echo "Sending invoke transaction on peer0.aphp..."
chaincodeInvoke 0 1
